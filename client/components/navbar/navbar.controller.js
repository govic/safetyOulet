...
angular.module('pruebaAngularApp')
  .controller('NavbarCtrl', function ($state, $cookieStore, $scope, $location, Auth, $http, $localStorage, $rootScope){
    ...
    $http.get('/api/filtros/actividades')
    .success(function(actividades){
      $scope.actividades = actividades;
      //console.dir($scope.actividades);
    });

    $http.get('/api/filtros/marcas')
    .success(function(marcas){
      $scope.marcas = marcas;
      //console.dir($scope.marcas);
    });

    //obtiene menu categorias
    //console.log('NavbarCtrl ... /api/filtros/menu');
